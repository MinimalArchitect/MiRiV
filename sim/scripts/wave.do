...
add wave -noupdate -expand -group fetch -childformat {{/tb_cpu/dut/pipeline_inst/fetch_inst/mem_out.address -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/fetch_inst/mem_out.wrdata -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/pipeline_inst/fetch_inst/mem_out.address {-radix hexadecimal} /tb_cpu/dut/pipeline_inst/fetch_inst/mem_out.wrdata {-radix hexadecimal}} /tb_cpu/dut/pipeline_inst/fetch_inst/mem_out
...
add wave -noupdate -expand -group decode -childformat {{/tb_cpu/dut/pipeline_inst/decode_inst/reg_write.reg -radix unsigned} {/tb_cpu/dut/pipeline_inst/decode_inst/reg_write.data -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/pipeline_inst/decode_inst/reg_write.reg {-radix unsigned} /tb_cpu/dut/pipeline_inst/decode_inst/reg_write.data {-radix hexadecimal}} /tb_cpu/dut/pipeline_inst/decode_inst/reg_write
...
add wave -noupdate -expand -group exec -childformat {{/tb_cpu/dut/pipeline_inst/exec_inst/op.rs1 -radix unsigned} {/tb_cpu/dut/pipeline_inst/exec_inst/op.rs2 -radix unsigned} {/tb_cpu/dut/pipeline_inst/exec_inst/op.readdata1 -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/exec_inst/op.readdata2 -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/exec_inst/op.imm -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/pipeline_inst/exec_inst/op.rs1 {-radix unsigned} /tb_cpu/dut/pipeline_inst/exec_inst/op.rs2 {-radix unsigned} /tb_cpu/dut/pipeline_inst/exec_inst/op.readdata1 {-radix hexadecimal} /tb_cpu/dut/pipeline_inst/exec_inst/op.readdata2 {-radix hexadecimal} /tb_cpu/dut/pipeline_inst/exec_inst/op.imm {-radix hexadecimal}} /tb_cpu/dut/pipeline_inst/exec_inst/op
add wave -noupdate -expand -group exec -radix hexadecimal /tb_cpu/dut/pipeline_inst/exec_inst/pc_in
add wave -noupdate -expand -group exec -childformat {{/tb_cpu/dut/pipeline_inst/exec_inst/reg_write_mem.reg -radix unsigned} {/tb_cpu/dut/pipeline_inst/exec_inst/reg_write_mem.data -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/pipeline_inst/exec_inst/reg_write_mem.reg {-radix unsigned} /tb_cpu/dut/pipeline_inst/exec_inst/reg_write_mem.data {-radix hexadecimal}} /tb_cpu/dut/pipeline_inst/exec_inst/reg_write_mem
...
add wave -noupdate -expand -group wb -radix hexadecimal /tb_cpu/dut/pipeline_inst/wb_inst/pc_old_in
add wave -noupdate -expand -group wb -childformat {{/tb_cpu/dut/pipeline_inst/wb_inst/reg_write.reg -radix unsigned} {/tb_cpu/dut/pipeline_inst/wb_inst/reg_write.data -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/pipeline_inst/wb_inst/reg_write.reg {-radix unsigned} /tb_cpu/dut/pipeline_inst/wb_inst/reg_write.data {-radix hexadecimal}} /tb_cpu/dut/pipeline_inst/wb_inst/reg_write
